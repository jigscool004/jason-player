...
package org.osmf.player.chrome.widgets
{
	...
	public class DisplayConfigWidget extends Widget
	{
		...
		public function DisplayConfigWidget()
		{	
			super();
			mouseEnabled = true;
		...
		private var disObj:DisplayObjectTrait;
		
		override protected function processRequiredTraitsAvailable(element:MediaElement):void
		{
			visible = true;
			
			disObj = media ? media.getTrait(MediaTraitType.DISPLAY_OBJECT) as DisplayObjectTrait : null;
		}
		...
		{		
			...
			{				
				...
				if(disObj.displayObject is VideoSurface)
				{
					var video:Video = (disObj.displayObject as VideoSurface).video;
					var brightness:Number = newVolume * 500 - 250;
					MediaConfiguration.setBrightness(video, brightness);
				}
			}
