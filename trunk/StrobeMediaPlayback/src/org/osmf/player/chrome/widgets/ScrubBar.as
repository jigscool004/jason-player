	...
	public class ScrubBar extends Widget
	{
		...
		override public function layout(availableWidth:Number, availableHeight:Number, deep:Boolean=true):void
		{
			...
			if (scrubber.width != scrubberWidth || lastWidth != availableWidth || lastHeight != availableHeight)
			{
				...
				scrubBarPlayedTrack.x = scrubBarTrack.x;
				scrubBarPlayedTrack.y = scrubBarTrack.y;
		...
		override public function set media(value:MediaElement):void
		{
			...
			// WORKARROUND: Dispatch TRAIT_ADD events for the traits that the media already has
